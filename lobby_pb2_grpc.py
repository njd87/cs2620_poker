...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in lobby_pb2_grpc.py depends on'
...
class LobbyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Lobby = channel.stream_stream(
...
def add_LobbyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Lobby': grpc.stream_stream_rpc_method_handler(
                    servicer.Lobby,
